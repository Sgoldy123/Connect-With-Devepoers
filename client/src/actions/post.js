import {DELETE_POST, GET_POSTS,POST_ERROR, UPDATE_LIKES, ADD_POST, GET_POST, ADD_COMMENT, REMOVE_COMMENT} from './type'
...
export const getPosts=()=>async(dispatch)=>{
    ...
    try {
        ...
        dispatch({
         ...
         dispatch(setAlert('error posts','danger',3000));
         dispatch({
             type:POST_ERROR,
...
export const addLikes =(postId)=>async (dispatch)=>{
    ...
    try {
        ...
        // dispatch(setAlert('already Liked','danger',3000));
        dispatch({
            type:POST_ERROR,
            payload:{msg:err.response.statusText,status:err.response.status}
        })
...
export const deletePost =(id)=>async (dispatch)=>{
    try {
        ...
        dispatch(setAlert('Removed Post','success',3000));
    } catch (err) {
